...
import { DEMO_IDS, VehicleStatus, } from "@lava-rapido/shared";
...
export const payments = pgTable("payments", {
    ...
    branchId: uuid("branch_id")
        .notNull()
        .references(() => branches.id, { onDelete: "restrict" }),
    vehicleEntryId: uuid("vehicle_entry_id").references(() => vehicleEntries.id, { onDelete: "set null" }),
    ...
    index("payments_tenant_branch_created_idx").on(t.tenantId, t.branchId, t.createdAt),
]);
...
export const vehicleEntriesRelations = relations(vehicleEntries, ({ one, many }) => ({
    tenant: one(tenants, {
